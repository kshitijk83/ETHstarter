...
var RequestIndex = function RequestIndex(props) {
  ...
  var renderRow = function renderRow() {
    return props.requests.map(function (request, index) {
      return __jsx(_components_RequestRow__WEBPACK_IMPORTED_MODULE_8__["default"], {
        key: index,
        id: index // approversCount={props.approversCount}
        ,
        request: request,
  ...
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], null, __jsx("h3", null, "Requests"), __jsx(_routes__WEBPACK_IMPORTED_MODULE_6__["Link"], {
    ...
    primary: true
  }, "Add Request"))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Table"], null, __jsx(Header, null, __jsx(HeaderCell, null, "ID"), __jsx(HeaderCell, null, "Description"), __jsx(HeaderCell, null, "Amount"), __jsx(HeaderCell, null, "Recipient"), __jsx(HeaderCell, null, "Approval Count"), __jsx(HeaderCell, null, "Finalize")), __jsx(Body, null, renderRow())));
};
...
//# sourceMappingURL=requests.js.2a59dfd5826950201b30.hot-update.js.map