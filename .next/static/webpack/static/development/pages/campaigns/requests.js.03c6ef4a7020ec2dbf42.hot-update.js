...
var RequestIndex = function RequestIndex(props) {
  ...
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], null, __jsx("h3", null, "Requests"), __jsx(_routes__WEBPACK_IMPORTED_MODULE_6__["Link"], {
    ...
    primary: true
  }, "Add Request"))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_5__["Table"], null, __jsx(Header, null, __jsx(Row, null, __jsx(HeaderCell, null, "ID"), __jsx(HeaderCell, null, "Description"), __jsx(HeaderCell, null, "Amount"), __jsx(HeaderCell, null, "Recipient"), __jsx(HeaderCell, null, "Approval Count"), __jsx(HeaderCell, null, "Approve"), __jsx(HeaderCell, null, "Finalize"))), __jsx(Body, null, renderRow())), __jsx("div", null, "Found ", props.requestCount, " requests"));
};
...
//# sourceMappingURL=requests.js.03c6ef4a7020ec2dbf42.hot-update.js.map